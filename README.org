...
#+begin_src emacs-lisp
  ...
  (use-package auto-dark
    :disabled t
    :custom
    (auto-dark-themes '((vscode-dark-plus) (solarized-selenized-white)))
...
#+begin_src emacs-lisp
  (use-package cape
    :ensure t
    :hook ((org-mode text-mode markdown-mode) . personal/cape-dict) ; only run when needed, it's expensive
    :init
